...
begin;
alter table velvet.setting add column set_phase_definition jsonb null
...
alter table velvet.destination_link add column set_phase_definition jsonb null
...
alter table velvet.destination_definition add column set_phase_definition jsonb null
...
alter table velvet.run add column execution_configuration jsonb null
