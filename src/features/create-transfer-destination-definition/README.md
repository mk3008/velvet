...
This operation registers a Destination Definition; it does not implement update or delete operations.

## Input

The public entrypoint accepts `CreateTransferDestinationDefinitionInput` with camelCase fields:
...
The registration entrypoint validates the minimum create rules before executing SQL:
...
SQL and result validation live under `queries/insert-transfer-destination-definition/`.
