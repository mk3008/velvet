...
describe('dedupeDdlInputsByInstanceAndPath', () => {
  it('keeps_same_path_for_different_instances', () => {
    const inputs = [
      { path: 'fixture/ddl/public.sql', instance: 'A' },
      { path: 'fixture/ddl/public.sql', instance: 'B' },
    ];
  ...
  it('dedupes_same_instance_and_same_path', () => {
    ...
    expect(result[0]).toEqual({ path: 'fixture/ddl/public.sql', instance: 'A' });
  });

  it('treats_empty_instance_as_part_of_key', () => {
    const result = dedupeDdlInputsByInstanceAndPath([
      { path: 'fixture/ddl/public.sql', instance: '' },
      { path: 'fixture/ddl/public.sql', instance: '' },
      { path: 'fixture/ddl/public.sql', instance: 'default' },
    ]);
